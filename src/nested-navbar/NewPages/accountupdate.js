...
const Accountupdate = ({ onClose, selectedAccount }) => {
  ...
  const updateContactstoAccount = (contactsIds) => {
    ...
    const existingContactIds = accountcontact.map((contact) => contact._id);
