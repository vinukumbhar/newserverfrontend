              ...
              <TableContainer component={Paper} sx={{ background: '#fdfdfd', marginBottom: 4, height: { xs: '50vh', md: 'auto' }, mt: 4 }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                  ...
                                  <Typography fontSize={13}>
                                    Invoice number: <Typography component="span" sx={{ color: '#cbd5e1', mr: 2, marginBottom: 2, fontSize: 13 }}>{invoicenumber}</Typography>
                                  </Typography>
                                </Box>
                                  <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <Box>
            ...
            <Grid xs={6}>
              <Box>
                ...
                <Autocomplete
                  ...
                  renderInput={(params) => <TextField {...params} placeholder="Select Account" variant="outlined" size="medium" sx={{ backgroundColor: "#fff" }} />}
                  sx={{ width: "100%", marginTop: "8px" }}
                />
              </Box>
            </Grid>
          ...
          <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} mt={2}>
                ...
                <FormControl fullWidth>
                  ...
                  <LocalizationProvider dateAdapter={AdapterDayjs}>
                    <DatePicker
                      ...
                      renderInput={(params) => <TextField {...params} size="medium" sx={{ width: "100%" }} />}
                    />
            ...
            <Grid xs={6}>
              <Box>
                ...
                <Autocomplete options={options} sx={{ mt: 2, mb: 2, backgroundColor: "#fff" }} size="medium" value={selecteduser} onChange={handleuserChange} isOptionEqualToValue={(option, value) => option.value === value.value} getOptionLabel={(option) => option.label || ""} renderInput={(params) => <TextField {...params} placeholder="Team Member" />} isClearable={true} />
              </Box>
            </Grid>
          </Grid>
          ...
          <Box sx={{ pt: 4, display: "flex", alignItems: "center", gap: 5, justifyContent: "space-between" }}>
            <Box sx={{ display: "flex", gap: 2 }}>
              <Button variant="contained"  onClick={createinvoice} sx={{
                backgroundColor: 'var(--color-save-btn)',  // Normal background
