...
// useEffect(() => {
//   // Check if the accountId cookie is present
//   const accountId = Cookies.get('accountId');

//   if (accountId) {
//     // If the cookie exists, log the accountId
...
// }, []);
  ...
  // Map selectedaccount to Autocomplete-compatible format
  // const selectedAccountOptions = accountoptions.filter((option) =>
  ...
  const DrawerContent = () => {
    ...
    //     const accountTags = accountdata
    //       .filter((account) => automationAccountId.includes(account._id))
    ...
    //     if (!tagMatch) {
    //       console.warn(
    //         `Tags do not match for automation index: ${automationIndex}. Skipping this automation.`
    //       );
    //       continue; // Skip this automation if tags don't match
    //     }
    //    // Check if automation has tags and if they match the account's tags
    ...
    //      )
    //    : true; // No tags mean no restriction
   
    //  if (!hasMatchingTags) {
    //    console.warn(
    //      `Automation skipped due to non-matching tags for index: ${automationIndex}`
    //    );
